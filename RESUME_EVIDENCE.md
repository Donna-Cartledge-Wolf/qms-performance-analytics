...
This file records project results that have been checked and can be used as evidence for resume, LinkedIn, GitHub, or portfolio statements.

Only results that are reproducible, technically validated, independently reviewed for plausibility, and traceable to the synthetic source data are included.
...
The synthetic dataset passed automated integrity checks for:
...
A numerical or performance claim may be used professionally only when it is:
